...
test("nested", () => {
    ...
    expect(makeIt(Person, { id: "1", name: "ali", child: { id: "2", name: "mohammad" } })).toEqual(ali);
    expect(makeIt(Person, { id: "1", name: "ali", child: { id: "2", name: "mohammad" } })).not.toStrictEqual(ali);
    expect(makeIt(Person, { id: "1", name: "ali", child: { id: "2", name: "mohammad" } }).child).toEqual(ali.child);
    expect(makeIt(Person, { id: "1", name: "ali", child: { id: "2", name: "mohammad" } }).child).not.toStrictEqual(ali.child);
});
